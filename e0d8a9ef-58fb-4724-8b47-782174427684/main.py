...
class TradingStrategy(Strategy):
    def __init__(self):
        ...
        self.tickers = ["TQQQ", "SQQQ"]  # SH is an ETF that inversely tracks SPY, used for shorting SPY in this example.
 ...
 if not d or "TQQQ" not in d[-1] or len(d) < 1:
        ...
        if current_time_est == "15:55":
            allocation_dict = {"TQQQ": 0.0, "SQQQ": 0.0}  # Close all positions by reallocating to 0.
